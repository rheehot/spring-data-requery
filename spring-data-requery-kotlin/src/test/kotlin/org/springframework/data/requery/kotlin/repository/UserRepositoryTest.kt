...
class UserRepositoryTest {
    ...
    fun testUpsertCascadesCollegues() {
        ...
        firstUser.colleagues.add(createUser("Tao", "Kim", "tagkim@coupang.com"))
    ...
    fun invokesQueryWithVarargsParametersCorrectly() {
        ...
        // FIXME: Parameter array의 memory address가 전달된다. In 에 대한 처리를 봐야 한다. 
    ...
    fun invokesQueryWithWrapperType() {
        ...
        val result = repository.findOptionalByEmailAddress("debop@coupang.com")
    ...
    //    fun findAllByNullExample() {
    //        repository.findAll(null as? Example)
    //    }
    ...
    fun testFindByEmailAddressJdbcStyleParameter() {
        ...
        val user = repository.findByEmailNativeAddressJdbcStyleParameter("debop@coupang.com")
