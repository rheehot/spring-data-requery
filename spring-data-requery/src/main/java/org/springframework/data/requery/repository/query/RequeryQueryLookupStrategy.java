...
public final class RequeryQueryLookupStrategy {
    ...
    public static QueryLookupStrategy create(RequeryOperations operations,
                                             Key key,
                                             RequeryPersistenceProvider extractor,
    ...
    private abstract static class AbstractQueryLookupStrategy implements QueryLookupStrategy {
        ...
        public AbstractQueryLookupStrategy(RequeryOperations operations, RequeryPersistenceProvider extractor) {
    ...
    private static class CreateQueryLookupStrategy extends AbstractQueryLookupStrategy {
        ...
        public CreateQueryLookupStrategy(RequeryOperations operations, RequeryPersistenceProvider extractor) {
