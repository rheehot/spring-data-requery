...
public class RequeryQueryMethod extends QueryMethod {
     ...
     */
    public RequeryQueryMethod(Method method, RepositoryMetadata metadata, ProjectionFactory factory, RequeryPersistenceProvider extractor) {
    ...
    RequeryPersistenceProvider getQueryExtractor() {
        return extractor;
    }
